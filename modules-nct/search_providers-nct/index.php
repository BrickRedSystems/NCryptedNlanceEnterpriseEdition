<?php
$reqAuth = false;
$module = 'search_providers-nct';
require_once "../../includes-nct/config-nct.php";
require_once "class.search_providers-nct.php";

$winTitle = $headTitle =  Search_Providers.' - ' . SITE_NM;
...
$obj = new Searchproviders($module, 0, $_REQUEST);
extract($_REQUEST);
