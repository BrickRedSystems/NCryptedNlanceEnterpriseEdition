...
$(document).on('click', '[data-ele="openInviteModal"]', function(e) {
    ...
    submitValueHandler(site_search_providers, 'action=method&method=invite_modal&userId='+userId+'&origin='+window.location.href, 'Please wait..', function(data) {        
...
$(document).on('shown.bs.modal', '#inviteModal', function(e) {    
    $('[data-ele="multiselectProjects"]').selectpicker();
    $.validate();
});
...
$(document).on('click', '[data-ele="submitInviteForm"]', function(e) {
    ...
    if ($('#' + formId).isValid()) {
        e.preventDefault();
        submitFormHandler(site_search_providers, formId, 'Please wait..', function(data) {
            $("#inviteModal").modal('hide');
            submitValueHandler(site_search_providers, 'action=method&method=inviteProvider', 'Please wait..');
...
$(document).ready(function() {
    ...
    $('[data-ele="multiselectsubcat"]').selectpicker();
    $('[data-ele="multiselectskills"]').selectpicker();
