...
$(document).ready(function() {
	...
	$('[data-ele="priceRange"]').ionRangeSlider({
		...
		onFinish : function(data) {
			...
			var url = site_search_projects + '?category=' + $('[data-ele="cat"]').val() + '&subcategory=' + $('[data-ele="multiselectsubcat"]').val() + '&skills=' + $('[data-ele="multiselectskills"]').val() + '&level=' + level + '&budget_from=' + data.from + '&budget_to=' + data.to;
			m(url, true, true, '.search-row', 'getPageContent');
