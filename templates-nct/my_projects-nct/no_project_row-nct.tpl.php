<div class="section-middle-right-project opacity_point2">
    <span class="profileimage">
        <img alt="" class="img-circle" src="{SITE_IMG}profileimage.jpg">
            <a href="#">
                Don Jonny
            </a>
        </img>
    ...
    <h4>
        <a href="#">
            Design a Logo for Spud on Stick for US Company
        </a>
        <button class="btn btn-primary small-btn featured-btn" type="button">
            Featured
        </button>
    </h4>
    <p>
