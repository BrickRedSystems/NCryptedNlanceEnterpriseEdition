							...
							<div class="post-project-form">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" tabindex="1" placeholder="{Enter_title_for_your_project}"
										name="title" 
							...
							<div class="post-project-form">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="tagsinput form-control" placeholder="{placeholder_seperate_skills_commas}" tabindex="6"
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="number" class="form-control" tabindex="7"
										name="budget"
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="number" class="form-control" tabindex="8"
										data-ele="duration"
										name="duration"
										data-validation="required number"
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<div class="input-group date" data-provide="datepicker" data-date-start-date="+1d" data-date-format="yyyy/mm/dd" data-date-autoclose="true">
								...
								<div class="col-sm-12">
									<button type="button" class="btn btn_blue btn-block btn_light_hover" data-ele="next" tabindex="10">
										{Next}
									</button>
								</div>
							</div>
							...
							<div class="post-project-form" id="fileupload" >
								<div class="col-sm-12">
									<div class="form-group">
										...
										<label class="btn btn-default btn-file upload-file"> 
										    <span class="drp-file" tabindex="11">{Drop_files_here_or_click_to_upload}</span> <!-- The file input field used as target for the file upload widget -->
								...
								<div class="col-sm-12">
									<div class="form-group check-box">
										<label class="control control--checkbox margintop15">{Mark_as_Featured}
											<input type="checkbox" checked="checked" name="isFeatured" id="isFeatured-input" value="y" tabindex="12"/>
								...
								<div class="col-sm-12">
									<div class="form-group days-count">
										...
										<input type="number" class="form-control days-number" tabindex="13"
										...
										data-validation-error-msg="{Please_enter_no_of_days_for_featuring_this_project}">
										<span class="days">
								...
								<div class="col-sm-12">
									...
									<input type="hidden" name="method" value="postProject"/>
									<button type="submit" class="btn btn_blue btn-block btn_light_hover" data-ele="finish" tabindex="14">
										{Pay_and_Submit}
									</button>
								</div>
							</div>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-download fade">
        ...
        <td>
            {% if (file.deleteUrl) { %}
                <button class="btn delete btn_blue_new cancel-btn" data-type="{%=file.deleteType%}" data-url="{%=file.deleteUrl%}"{% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
