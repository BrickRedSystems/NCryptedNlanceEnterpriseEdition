<?php
	...
	include("class.report_project-nct.php");
	...
	$mainObject = new ReportProject($module,$id,$searchArray,$action);
	//dump_exit($action);
	if($action == "delete"  && in_array('delete',$Permission)) {
		...
		exit;	
	}else if(isset($_REQUEST['switch_action']) && $_REQUEST['switch_action'] == "featured" && in_array('status',$Permission)) {
