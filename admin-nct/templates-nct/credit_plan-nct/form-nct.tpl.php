<form action="" method="post" name="frmCont" id="frmCont" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
	<div class="form-body">
	 	<div class="form-group"> 
	 		<label for="plan_name" class="control-label col-md-3"><font color="#FF0000">*</font>Plan Name: &nbsp;</label> 
	 		<div class="col-md-4"> 
	 			<input type="text" class="form-control logintextbox-bg required" name="planName" id="planName" value="%PLAN_NAME%"> 
	 		</div>
	 	</div>
	 	<div class="form-group"> 
	 		<label for="plan_price" class="control-label col-md-3"><font color="#FF0000">*</font>Plan Price : &nbsp;</label> 
	 		<div class="col-md-4"> 
