    <script type="text/javascript">
	  ...
	  OTable = $('#example123').dataTable( {
			...
			"fnServerData": function (sSource, aoData, fnCallback) {
			 ...
			 "aoColumns": [
			 	{ "sName": "id", 'sTitle' : 'Report ID'},
				{ "sName": "userName", 'sTitle' : 'Sender'},
				{ "sName": "title", 'sTitle' : 'Project Title'},
				{ "sName": "createdDate", 'sTitle' : 'Posted Date'}
				<?php if(in_array('status',$this->Permission)){ ?>
				,{ "sName": "emailStatus", 'sTitle' : 'Status',bSearchable:false}
				<?php } ?>
	...
	$(document).on('submit','#frmCont', function(e){
		...
		$("#frmCont").validate({
			...
			messages:{
				reply:{
					required: 'Please enter your reply before submitting.'
				}
			},
