<script type="text/javascript">
    $(function () {
        ...
        "bProcessing": true,
                ...
                "aaSorting" : [],
                "aoColumns": [
                { "sName": "parentId", "sTitle" : 'Content Id', bVisible: false},
                { "sName": "pageTitle", 'sTitle' : 'Page Title'},
                { "sName": "pageSlug", 'sTitle' : 'Page Slug'}
    ...
    $(document).on('click', '#submitAddForm', function (e) {
        ...
        $.validator.addClassRules("pageDesc", { cRequiredDesc: true } );

        $.validator.addMethod("cRequiredTitle", $.validator.methods.required,
        "Page title is required.");
        $.validator.addClassRules("pageTitle", { cRequiredTitle: true } );
