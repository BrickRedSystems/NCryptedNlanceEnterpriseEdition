...
if(! defined('NOT_FOUND_IMAGE') )			define ('NOT_FOUND_IMAGE', '../themes-nct/images-nct/no_image.jpg');							// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )				define ('ERROR_IMAGE', '../themes-nct/images-nct/no_image.jpg');								// Image to serve if an error occurs instead of showing error message 
...
class timthumb {
	...
	protected function processImageAndWriteToCache($localImage){
		...
		/*
         * Note: changed by Ashish Joshi for below quote:
         * "If no 'w' or 'h' are provided, the image will be displayed at original size instead of default width and height."
